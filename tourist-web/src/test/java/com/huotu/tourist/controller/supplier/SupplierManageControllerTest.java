...
public class SupplierManageControllerTest extends AbstractSupplierTest {
    ...
    public void orderList() throws Exception {
        ...
        TouristOrder order = createTouristOrder(good, null, orderNo, null, null, null, null, null, null, null);
...
//                .param(sizeParameterName,"10")
        ...
        //预期
        order = createTouristOrder(good, createTouristBuyer("wy", null, null, null), null, null, null, null, null, null, null, null);
        ...
        for(int i=0;i<3;i++){
            touristOrders.add(createTouristOrder(good,null,null,null,
                    LocalDateTime.of(2016, i * 3 + 1, 1, 1, 1), null, null, null, null, null));
        }
        ...
        order = createTouristOrder(touristGood, null, null, null, null, null, null, null, null, null);
        ...
        //预期
        order = createTouristOrder(good, null, null, null, null, null, null, null, createSettlementSheet(null, null, supplier.getSupplierName()), null);
    ...
    public void modifyOrderTouristDate() throws Exception{
        ...
        TouristOrder order = createTouristOrder(null, null, "slt", null, null, null, null, null, null, null);
